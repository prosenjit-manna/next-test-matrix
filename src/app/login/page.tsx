...
import { handleSignInWithGithub } from "../componets/authAction";
            ...
            <div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                ...
                <form action={handleSignInWithGithub}>
                     <Button type="submit" className="cursor-pointer flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50 focus-visible:ring-transparent">
